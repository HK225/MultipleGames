...
def polypracticing():
  ...
  #   int1=0
  #   int2=0
  #   while int3==int4 or int3==int1 or int3==int2 or int4==int1 or int4==int2 or int1==int2:
  #     int1=random.randint(1,30)
  #     int2=random.randint(1,30)
  #     int3=random.randint(1,5)
  #     int4=random.randint(1,5)    
  #   phrase="Factor " + str(int3*int4) + "x^2+" + str(int3*int2+int4*int1) + "x+" + str(int1*int2) + ". You have one try."
  # if session["numberthings"]==1:
  #   session["listthings"].append(int1)
  #   session["listthings"].append(int2)
  #   session["listthings"].append(int3)
  #   session["listthings"].append(int4)
  #       return render_template("polypractice.html", phrase=phrase)
  #   int3r=int(input("What is the coefficient of x in the first factor?"))
  #   if int3r==int3:
  #     int1r=int(input("Correct. What is the constant in the first factor?"))
  #     if int1r==int1:
  #       int4r=int(input("Correct. What is the coefficient of x in the second factor?"))
  #       if int4r==int4:
  #         int2r=int(input("Correct. What is the constant in the second factor?"))
  #         if int2r==int2:
  #           print("You have successfully factored the quadratic.")
  #   elif int3r==int4:
  #     int1r=int(input("Correct. What is the constant in the first factor?"))
  #     if int1r==int2:
  #       int4r=int(input("Correct. What is the coefficient of x in the second factor?"))
  ...
  #           print("You have successfully factored the quadratic.")
  # elif deg==3:
  #   int5=random.randint(1,15)
  #   int6=random.randint(1,15)
  #   int7=random.randint(1,15)
  #   phrase="Factor x^3-"+str(int5+int6+int7)+"x^2+"+str(int5*int6+int6*int7+int5*int7)+"x-"+str(int5*int6*int7)+"."
  #   session["listthings"].append(int5)
  #   session["listthings"].append(int6)
  #   session["listthings"].append(int7)

  #   int5r=int(input("What is the constant term of the first factor?"))
  #   if int5r==int5:
  #     int6r=int(input("Correct. What is the constant term of the second factor?"))
  #     if int6r==int6:
  #       int7r=int(input("Correct. What is the constant term of the third factor?"))
  #       if int7r==int7:
  #         print("You have successfully factored the cubic.")
  #     elif int6r==int7:
  #       int7r=int(input("Correct. What is the constant term of the third factor?"))
  #       if int7r==int6:
  #         print("You hace succesfully factored the cubic.")
  #   elif int5r==int6:
  #     int6r=int(input("Correct. What is the constant term of the second factor?"))
  #     if int6r==int5:
  #       int7r=int(input("Correct. What is the constant term of the third factor?"))
  ...
  #       int7r=int(input("Correct. What is the constant term of the third factor?"))
  #       if int7r==int7:
  #         print("You have succesfully factored the cubic.")
  #   elif int5r==int7:
  #     int6r=int(input("Correct. What is the constant term of the second factor?"))
  #     if int6r==int5:
  #       int7r=int(input("Correct. What is the constant term of the third factor?"))
...
# @app.route("/simulatevote", methods=["GET", "POST"])
# def simulatevote():
#   list=[]
...
@app.route("/yapping") 
def yapping():
  return render_template("yapping.html")
